...
load("@pip_gpu_cuda12_8_torch//:requirements.bzl", requirement_gpu_cuda12_8="requirement")
...
def torch_deps():
    deps = select({
        ...
        "@//:using_cuda12_8_x86": [
            "@torch_2.7_py310_cuda//:torch_api",
            "@torch_2.7_py310_cuda//:torch",
            "@torch_2.7_py310_cuda//:torch_libs",
        ],
        "@//:using_cuda12_9_x86": [
